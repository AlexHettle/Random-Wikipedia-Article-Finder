...
the_canvas.create_rectangle(30,0,35,240,fill="#80e2ee",outline="")
the_canvas.create_rectangle(470,0,500,240,fill="blue",outline="")
the_canvas.create_rectangle(465,0,470,240,fill="#80e2ee",outline="")
the_canvas.place(x=0,y=0)
window.title("Random Wikipedia Article Generator")
window.resizable(False, False)
window.geometry("500x240")
generate_article=Button(text="GENERATE NEW ARTICLE",font=("Verdana",20),pady=0,command=lambda:get_article(link),borderwidth=10,bg="white")
generate_article.pack(side=BOTTOM)
title=Label(text="Wikipedia Article Generator",font=("Verdana",20),justify=CENTER,bg="white")
title.pack(side=TOP)
link=Label(text="\nClick GENERATE to get a link to a random Wikipedia article",font=("Verdana",20),justify=CENTER,wraplength=400,bg="white")
link.pack(side=TOP)
window.mainloop()
